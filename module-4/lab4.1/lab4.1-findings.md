...
*(Board architecture and label ontology based on the [Official GitHub Projects Documentation](https://docs.github.com/en/issues/planning-and-tracking-with-projects/learning-about-projects/about-projects)).*
...
*(Lifecycle stages and escalation routing aligned with [Atlassian's ITIL Incident Management Framework](https://www.atlassian.com/itsm/incident-management)).*
...
## 4. Reflection
Using GitHub Issues simulates professional ITSM tools like Zoho Desk or Jira Service Management. This lab reinforced the importance of the "Never Trust, Always Verify" model by ensuring specific application access and maintaining a documented security trail for every incident.